...
//Battles have some parameters that need to be inserted by the creator, these parameters must respect the following ocntraints:
//	- The number of minimum students per team must be less or equal than the maximum number of students
...
sig Battle{
	...
	(registrationDeadline.month = submissionDeadline.month) implies
